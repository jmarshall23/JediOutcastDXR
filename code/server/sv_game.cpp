...
void SV_InitGameProgs (void) {
	...
	import.ReadFromSaveGame_fn	= SG_Read;
	import.ReadFromSaveGameOptional_fn = SG_ReadOptional;
...
*/
	...
	import.G2API_InitGhoul2Model_fn = G2API_InitGhoul2Model;
	...
	import.G2API_SetBoneAngles_fn = G2API_SetBoneAngles;
	import.G2API_SetBoneAnglesMatrix_fn = G2API_SetBoneAnglesMatrix;
	import.G2API_SetBoneAnim_fn = G2API_SetBoneAnim;
	...
	import.G2API_CopyGhoul2Instance_fn = G2API_CopyGhoul2Instance;
	...
	import.G2API_SetBoneAnglesIndex_fn = G2API_SetBoneAnglesIndex;
	import.G2API_SetBoneAnglesMatrixIndex = G2API_SetBoneAnglesMatrixIndex;
	import.G2API_SetBoneAnimIndex_fn = G2API_SetBoneAnimIndex;
