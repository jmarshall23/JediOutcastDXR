...
void CL_InitUI( void ) {
	...
	uii.R_Font_StrLenPixels_fn = re.Font_StrLenPixels_fn;
	uii.R_Font_StrLenChars		= re.Font_StrLenChars_fn;
	uii.R_Font_HeightPixels_fn = re.Font_HeightPixels_fn;
	uii.R_Font_DrawString_fn = re.Font_DrawString_fn;
