...
void GL_SetDefaultState( void )
{
	...
	if ( glPNTrianglesiATI )
	{
		...
		glPNTrianglesiATI( GL_PN_TRIANGLES_TESSELATION_LEVEL_ATI, 3 );
	}
#endif // _NPATCH
}
...
refexport_t *GetRefAPI ( int apiVersion, refimport_t *rimp ) {
	...
	re.Font_StrLenPixels_fn = RE_Font_StrLenPixels;
	re.Font_StrLenChars_fn = RE_Font_StrLenChars;
	re.Font_HeightPixels_fn = RE_Font_HeightPixels;
	re.Font_DrawString_fn = RE_Font_DrawString;
