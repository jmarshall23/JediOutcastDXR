...
typedef struct {
	...
	int (*ReadFromSaveGame_fn)(unsigned long chid, void* pvAddress, int iLength, void** ppvAddressPtr);
	int (*ReadFromSaveGameOptional_fn)(unsigned long chid, void* pvAddress, int iLength, void** ppvAddressPtr);

	inline int ReadFromSaveGame(unsigned long chid, void* pvAddress, int iLength, void** ppvAddressPtr = NULL)
	{
		return ReadFromSaveGame_fn(chid, pvAddress, iLength, ppvAddressPtr);
	}

	inline int ReadFromSaveGameOptional(unsigned long chid, void* pvAddress, int iLength, void** ppvAddressPtr = NULL)
	{
		return ReadFromSaveGameOptional_fn(chid, pvAddress, iLength, ppvAddressPtr);
	}
	...
	void (*trace_fn)(trace_t* results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end,
	...
	{
		trace_fn(results, start, mins, maxs, end, passEntityNum, contentmask, eG2TraceType, useLod);
	}
...
*/
	...
	int			(*G2API_InitGhoul2Model_fn)(CGhoul2Info_v& ghoul2, const char* fileName, int modelIndex,
	...
	{
		return G2API_InitGhoul2Model_fn(ghoul2, fileName, modelIndex, customSkin, customShader, modelFlags, lodBias);
	}
	...
	qboolean(*G2API_SetBoneAnim_fn)(CGhoul2Info* ghlInfo, const char* boneName, const int startFrame, const int endFrame,
	...
	{
		return G2API_SetBoneAnim_fn(ghlInfo, boneName, startFrame, endFrame, flags, animSpeed, currentTime, setFrame, blendTime);
	}
	...
	qboolean(*G2API_SetBoneAngles_fn)(CGhoul2Info* ghlInfo, const char* boneName, const vec3_t angles,
	...
	{
		return G2API_SetBoneAngles_fn(ghlInfo, boneName, angles, flags, up, right, forward, modelList, blendTime, blendStart);
	}

	qboolean(*G2API_SetBoneAnglesMatrix_fn)(CGhoul2Info* ghlInfo, const char* boneName, const mdxaBone_t& matrix, const int flags,
	...
	{
		return G2API_SetBoneAnglesMatrix_fn(ghlInfo, boneName, matrix, flags, modelList, blendTime, currentTime);
	}
	...
	void		(*G2API_CopyGhoul2Instance_fn)(CGhoul2Info_v& ghoul2From, CGhoul2Info_v& ghoul2To, int modelIndex);
	inline void G2API_CopyGhoul2Instance(CGhoul2Info_v& ghoul2From, CGhoul2Info_v& ghoul2To, int modelIndex = -1)
	{
		G2API_CopyGhoul2Instance_fn(ghoul2From, ghoul2To, modelIndex);
	}
	...
	qboolean(*G2API_SetBoneAnglesIndex_fn)(CGhoul2Info* ghlInfo, const int index, const vec3_t angles, const int flags,
	...
	inline qboolean G2API_SetBoneAnglesIndex(CGhoul2Info* ghlInfo, const int index, const vec3_t angles, const int flags,
		...
		qhandle_t* modelList, int blendTime = 0, int currentTime = 0)
	{
		return G2API_SetBoneAnglesIndex_fn(ghlInfo, index, angles, flags, yaw, pitch, roll, modelList, blendTime, currentTime);
	}
	...
	qboolean(*G2API_SetBoneAnimIndex_fn)(CGhoul2Info* ghlInfo, const int index, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame, const int blendTime);
	...
	{
		return G2API_SetBoneAnimIndex_fn(ghlInfo, index, startFrame, endFrame, flags, animSpeed, currentTime, setFrame, blendTime);
	}
